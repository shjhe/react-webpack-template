...
choosePort(HOST, DEFAULT_PORT)
  .then(port => {
    ...
    const compiler = createCompiler(webpack, devWebpackConfig, appName, urls, useYarn);
    // Load proxy config
    // 使用config/index中的配置
    // 因为在packge.json中配置 不能注释 会很麻烦
    const proxySetting = config.dev.proxy // require(paths.appPackageJson).proxy;
